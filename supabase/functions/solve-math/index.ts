          ...
          messages: [
            {
              role: "system",
              content:
                "You are a math expert. Analyze the screenshot and solve all math problems. Show every step clearly.",
            },
            {
              role: "user",
              content: [
                {
                  type: "text",
                  text: "Solve this math problem from the screenshot. Show your work.",
                },
                {
                  type: "image_url",
